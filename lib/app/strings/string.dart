...
class Strings {
  ...
  static String app_Quotes = "Share File Instantly Like A Flash";
  static String app_Moto = "Quickly Share & Receive Files";
  static String history = "History";
  static String storage_Location = "Storage Location";
